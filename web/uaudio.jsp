...
<body>
 ...
 <header> 
  ...
  <div class="w3-container">
         <div class="w3-center" style=" margin-top: 45px; font-family: Cuprum, Arial, Helvetica, sans-serif;font-size: 50px;
       color: #6666ff;">U-AUDIO</div>>
         <hr style="border: 0;
    height: 15px;
  ...
  <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
      <h1 class="w3-center">APOLLO 16</h1>   
      <hr class="w3-clear" >
          <div class="w3-row-padding" style="margin:0 -16px">
              <div id="slider">
        <img class="slide" src="uaudio-interface/apollo_16_carousel_1.jpg"  style="background-color: black">
	<img class="slide1" src="uaudio-interface/apollo_16_carousel_3_1.jpg"  style="background-color: black">
	<img class="slide" src="uaudio-interface/apollo_16_carousel_2_1.jpg"  style="background-color: black">
    
        </div>

                  <br>
                  <h4 class="w3-center" style="width:750px "> Apollo 16 is the flagship of Universal Audio’s acclaimed Apollo recording interface range for Mac and Windows — giving professional and commercial studios UA’s finest A/D and D/A conversion with the tone, feel, and realtime workflow of classic analog recording.
...
Built upon UA’s 60-year heritage of audio craftsmanship, Apollo 16 distinguishes itself with 16 x 16 analog I/O, onboard UAD-2 QUAD Core processing, and an included bundle of award-winning UAD plug-ins — which you can track through with near-zero latency, shaping sounds like a classic analog studio — without taxing your host Mac or PC.
               ...
               <p style="padding-left:1125px"><button class="w3-button w3-padding-large w3-white w3-border"><b><a href="ChangeInfo.jsp">ADD TO CART</a></b></button></p>
  ...
  <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
      <h1 class="w3-center">APOLLO 8</h1>   
      <hr class="w3-clear" >
          <div class="w3-row-padding" style="margin:0 -16px">
              <div id="slider">
        <img class="slide" src="uaudio-interface/apollo_8_carousel_1_1.jpg"  style="background-color: black">
        </div>

                  <br>
                  <h4 class="w3-center" style="width:750px ">Apollo 8 is the world’s most acclaimed professional recording interface for Mac and Windows, giving project and commercial studios superior A/D and D/A conversion with the tone, feel, and realtime workflow of classic analog recording.
...
Built upon UA’s 60-year heritage of audio craftsmanship, Apollo 8 distinguishes itself with four Unison™-enabled mic preamps, UAD-2 QUAD or DUO Core processing, and an included bundle of award-winning UAD plug-ins — which you can track through with near-zero latency, shaping sounds like a classic analog studio — without taxing your host Mac or PC.
  ...
  <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
      ...
      <hr class="w3-clear" >
          <div class="w3-row-padding" style="margin:0 -16px">
              <div id="slider">
        <img class="slide" src="uaudio-interface/apollo_twin_carousel_1.jpg"  style="background-color: black">
        </div>

                  <br>
                  <h4 class="w3-center" style="width:750px ">With its class-leading resolution and Realtime UAD Processing, Apollo Twin USB sets a new standard for desktop music production. 
