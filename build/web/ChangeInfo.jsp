  ...
  <div class="w3-card-4 w3-margin w3-white">
    <div class="w3-container w3-center">
      ...
      <div class="w3-row-padding">
       ...
       <h5 class="w3-opacity">*Insert your ID</h5>
              <input type="text" name="idishka">
              <h5 class="w3-opacity" style="padding-top:40px;">*Change login</h5>
              <input type="text" name="changeLogin" value="<%session=request.getSession(); 
         out.println(session.getAttribute("send1"));%>">
              <h5 class="w3-opacity" style="padding-top:40px;">*Change password</h5>
              <input type="text" name="changePassword" value="<%session=request.getSession(); 
         out.println(session.getAttribute("send2"));%>">
                 <h5 class="w3-opacity" style="padding-top:40px;">*Change name</h5>
              <input type="text" name="changeName" value="<%session=request.getSession(); 
         out.println(session.getAttribute("login"));%>">
              <h5 class="w3-opacity" style="padding-top:40px;">*Change surname</h5>
              <input type="text" name="changeSurname" value="<%session=request.getSession(); 
         out.println(session.getAttribute("surname"));%>">
               <h5 class="w3-opacity" style="padding-top:40px;">*Change email</h5>
              <input type="text" name="changeEmail" value="<%session=request.getSession(); 
         out.println(session.getAttribute("email"));%>">
       <h5 class="w3-opacity" style="padding-top:40px;">*Change number</h5>
              <input type="text" name="changeNumber" value="<%session=request.getSession(); 
         out.println(session.getAttribute("number"));%>">
               <h5 class="w3-opacity" style="padding-top:40px;">*Change address</h5>
              <input type="text" name="changeAddress"value="<%session=request.getSession(); 
         out.println(session.getAttribute("address"));%>">
        <p style="padding-left:650px"><input  type="submit" class="w3-button w3-padding-large w3-white w3-border" value="SUBMIT »"></p>              
             </form>
            </div>
        </div>
      </div>
